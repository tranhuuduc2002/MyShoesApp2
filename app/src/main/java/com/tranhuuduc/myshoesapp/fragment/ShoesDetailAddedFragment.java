...
public class ShoesDetailAddedFragment extends Fragment {
    ...
    public ShoesDetailAddedFragment(ShoesModel Shoes) {
        this.mShoes = Shoes;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_shoes_detail_added, container, false);
        initUi();
        return mView;
    }
                    ...
                    if (getActivity() != null) {
                        MyShoesApplication.get(getActivity()).getHistoryDatabaseReference()
                                ...
                                .setValue(history, (error, ref) -> {
                                    GlobalFunction.showToast(getActivity(), getString(R.string.msg_add_shoes_success));
                    ...
                    if (getActivity() != null) {
                        MyShoesApplication.get(getActivity()).getHistoryDatabaseReference()
                                ...
                                .updateChildren(map, (error, ref) -> {
                                    GlobalFunction.hideSoftKeyboard(getActivity());
                                    GlobalFunction.showToast(getActivity(), getString(R.string.msg_edit_add_history_success));
                                    changeQuantity(history.getshoesId(), Integer.parseInt(strQuantity) - history.getQuantity(), true);
        ...
        new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(getString(R.string.action_delete), (dialogInterface, i)
                        ...
                        .removeValue((error, ref) -> {
                            GlobalFunction.showToast(getActivity(), getString(R.string.msg_delete_add_history_success));
