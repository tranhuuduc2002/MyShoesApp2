...
public class ManageShoesActivity extends BaseActivity {
    ...
    private void initToolbar() {
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(getString(R.string.feature_manage_shoes));
        ...
        edtSearchName.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (strKey.equals("") || strKey.length() == 0) {
                    mKeySearch = "";
                    getListShoes();
                    GlobalFunction.hideSoftKeyboard(ManageShoesActivity.this);
                }
            }
        });
    ...
    public void getListShoes() {
        if (mListShoes != null) {
            mListShoes.clear();
            MyShoesApplication.get(this.getApplicationContext()).getShoesDatabaseReference().removeEventListener(mChildEventListener);
        }
        MyShoesApplication.get(this.getApplicationContext()).getShoesDatabaseReference().addChildEventListener(mChildEventListener);
    }
